...
namespace PinInCSharp {
  public class PinIn {
    ...
    private readonly Elements.Char[] chars = new Elements.Char[char.MaxValue];
    private readonly Elements.Char.Dummy temp = new Elements.Char.Dummy();
    ...
    /// </summary>
    public PinIn() : this(PinInData.data) { }

    public PinIn(Dictionary<char, string> data) {
